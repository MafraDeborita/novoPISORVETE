...
<div id="diferencial"><h2>Nossos Diferenciais</h2></div>
...
<div id="campeoes"><h2>Os Campeões de Venda</h2></div>

<div id="maisvendidos">
    <div id="card1" >
        <img src="../img/sorvete2.webp" alt="Avatar" width="250px" height="300px">
        <div class="container">
          <a href="/views/produto01.php"><h4><b>Chocolate Amargo</b></h4> 
          <p>R$ 9,99</p></a> 
        </div>
      </div>
      ...
      <div id="card2" >
        <img src="../img/sorvete2.webp" alt="Avatar" width="250px" height="300px">
        <div class="container">
          <a href=""><h4><b>Chocolateao Leite</b></h4> 
          <p>delicius sorventin</p></a> 
        </div>
      </div>
     ...
     <div id="card3" >
        ...
        <div class="container">
          <a href=""><h4><b>Chocolate Branco</b></h4> 
          <p>R$ 9,99</p></a> 
        </div>
      </div>
...
<div id="maisvendidos">
    <div id="card1" >
        ...
        <div class="container">
          <a href=""><h4><b>Chocolate Amargo</b></h4> 
          <p>R$ 9,99</p></a> 
        </div>
      </div>
